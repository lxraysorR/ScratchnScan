...
function chipsRecipeFromContext(ctx) {
  ...
  return {
    ...
    whyCleaner: ["Uses real potato slices with simple seasoning.", "Lets you control oil amount and salt level.", claimsLine],

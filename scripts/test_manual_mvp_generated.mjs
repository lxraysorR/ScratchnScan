...
for (const token of ['toggleMvpFavorite', 'deleteMvpRecipe', 'window.confirm', 'View Details']) {
...
for (const token of ['details-source-ingredients', 'details-notes', 'window.confirm']) {
...
for (const token of ['Product name is required.', 'Ingredients or label text is required.', 'scan-fallback-note', 'submitBtn.disabled = true']) {
